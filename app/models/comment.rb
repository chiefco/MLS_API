    ...
    comments=[]
      unless messages.nil?
        messages.each do |message|
          ...
          comment=user.comments.create(:commentable_type=>"Attachment",:commentable_id=>attachment,:message=>message[:message],:community_id=>message[:community_id], :item_id => (item.blank? ? nil : item._id))
