class Invite < ActionMailer::Base
  ...
  def community_invite(inviter,invitation,community, message)
    ...
    mail(:to=>@invitee, :subject =>"Invitation for virtual team from #{@inviter}", :reply_to => "info@meetlinkshare.com")
  end
  ...
  def share_send_email(user, user_name, community_id, community_name, email, files_length, folders_length, file_names, folder_names)
    ...
    mail(:to=>@email, :subject =>"Files shared for virtual team(#{@community_name}) by #{@user_name}", :reply_to => "info@meetlinkshare.com")
  end
  ...
  def upload_send_email(upload_user, user_name, community_id, community_name, email, file_name, file_count)
    @user_name, @community_id, @community_name, @email, @file_name, @file_count = user_name, community_id, community_name, email, file_name, file_count
     mail(:to=>@email, :subject =>"Files uploaded for virtual team(#{@community_name}) by #{@user_name}", :reply_to => "info@meetlinkshare.com")
   end
  ...
  def remove_member_notifications(current_user_email, current_user_name, community_name, email, names)
    @user_name, @community_name, @email, @names = current_user_name, community_name, email, names
     mail(:to=>@email, :subject =>"Notifications for virtual team(#{@community_name}) from #{@user_name}", :reply_to => "info@meetlinkshare.com")
  end
  ...
  def shared_unsubscribe_notifications(current_user_name, community_name, email)
    @user_name, @community_name, @email = current_user_name, community_name, email
     mail(:to=>@email, :subject =>"Notifications for virtual team(#{@community_name}) from Meetlinkshare.com", :reply_to => "info@meetlinkshare.com")
   end
  ...
  def share_delete_email(current_user_email,current_user_name,  community_id, community_name, email, count, item_name)
    ...
    mail(:to=>@email, :subject =>"Files deleted for virtual team(#{@community_name}) by #{@user_name}", :reply_to => "info@meetlinkshare.com")
  end
  ...
  def notes_share_send_email(user, user_name, community_id, community_name, email, notes_length,  note_names)
    ...
    mail(:to=>@email, :subject =>"Notes shared for virtual team(#{@community_name}) by #{@user_name}", :reply_to => "info@meetlinkshare.com")
  end
  ...
  def community_accept_notifications(current_user_name, community_id, community_name, email)
    @user_name, @community_id, @community_name, @email  = current_user_name, community_id, community_name, email
     mail(:to=>@email, :subject =>"#{@user_name}  has joined the team #{@community_name} on Meetlinkshare", :reply_to => "info@meetlinkshare.com")
  end
