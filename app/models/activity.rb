class Activity
  ...
  validates_inclusion_of :entity_type, :in=>["Item","Category","Bookmark","Topic", "Community","Share", "Attachment", "Invitation"], :message=>"activity_type  - Required parameter missing", :code=>2015
