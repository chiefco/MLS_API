class Invite < ActionMailer::Base
  ...
  def community_invite(inviter,invitation,community)
    ...
    mail(:to=>@invitee, :subject =>"Invitation for virtual team from #{@inviter}")
  end
  ...
  def send_invitations(user,email,community_id="", community="")
    ...
    mail(:to=>email, :subject =>"Invitation for MeetLinkShare")
  end

  def share_community(user,item)
    @user,@item=user,item
    mail(:to=>@user.email, :subject =>"Invitation for MeetLinkShare")
  end
  ...
  def community_accept_notifications(current_user_name, community_id, community_name, email)
    @user_name, @community_id, @community_name, @email  = current_user_name, community_id, community_name, email
     mail(:to=>@email, :subject =>"#{@user_name}  has joined the team #{@community_name} on Meetlinkshare")
  end
